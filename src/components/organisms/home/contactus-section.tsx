          ...
          <div className="space-y-8 w-lg">
            <div className="space-y-16 mt-12">
              <div>
                ...
                <p className="text-sm">+94 721213159</p>
              </div>

              <div>
                <p className="text-xl text-white mb-4">Email Address</p>
                <p className="text-sm">tekla@gmail.com</p>
              </div>

              <div>
                <p className="text-xl text-white mb-4">office address</p>
                <p className="text-sm">104/1/1 High Level Rd, Colombo 00600</p>
              </div>
            </div>
          </div>
        </div>
